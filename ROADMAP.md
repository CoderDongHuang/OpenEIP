...
v0.7 ──→ Governance          API/DB/UI 设计完成，架构/安全评审中
...
| Phase 6：Governance | API/DB/UI 设计完成，架构/安全评审中 | RFC-0009、ADR-0015 至 ADR-0018 已接受；设计包与评审材料已完成；独立批准前实现尚未开始 |
...
- `v0.6.0-alpha` Agent 已于 2026-08-31 作为 GitHub Pre-release 发布；PR #100、Release workflow、Tag 和 GHCR 镜像证据均已记录。PR #97/#100 缺少正式 Review，按维护者授权记录为流程例外。
