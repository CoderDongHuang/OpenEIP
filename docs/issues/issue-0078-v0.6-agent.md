...
| 2 RFC                 | RFC-0008                                        | Proposed; governance decision pending |
| 3 ADR                 | ADR-0012, ADR-0013, ADR-0014                    | Proposed; governance decision pending |
...
| 6 Architecture Review | Architecture and security design review records | Awaiting independent approval         |
| 7-17                  | Implementation through release                  | Not started                           |
