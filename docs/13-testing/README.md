...
| Performance v0.9 | [Plan](v0.9-performance-test-plan.md) | [Result](results/v0.9-performance-baseline.json) | 200 requests, P99 19.203 ms, 4-way concurrency, zero errors; rerun with `benchmark/local_fixture.py` on release commit |
...
## v0.4 Workflow Candidate

- [Test plan](v0.4-workflow-test-plan.md)
- [Workflow benchmark](results/workflow-benchmark.json): 1,000 node transitions, P99 36.09 ms;
  100 concurrent executions complete in 318.53 ms at 313.94 executions/s.
- MySQL 8.4 migration, durability indexes, strict OpenAPI/event contracts and rollback are exercised by
  Testcontainers.
